...
- 「Peopleware（ピープルウェア）」「How to solve it」など特定の書籍を指す場合
...
こちらについては原著側で乱用気味にも見えますので、以下くらいにしたいと考えてます。（ルールで縛りは入れません、各翻訳担当・部の範囲で統一くらいとします）

**斜字や太字などの修飾表現：必須対応ケース**

斜字や太字などの修飾表現について、必須となる対応ケースは以下の3点とします。

1. 特定の書籍を指す場合：英語名のままイタリック（*1つで囲む）表現とする
