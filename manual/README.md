...
**斜字や太字などの修飾表現への対処（調整中：まず、キックオフまでに改善）**

- すべて対応する必要はありません
- 斜字（イタリック）は読みづらいので使用しないようにします
- 「」もしくは太字で対処することとします
- 書籍に関しては「」で囲みます（仮）
- 索引対象は下記「I) 索引向けの単語」を参考にHTMLタグを入れます、太字等は任意に…
- 明確な引用だけはわかるようにします（記述方法はオーム社と調整予定）
- メモ：6版日本語のパターンだけは明記するかも
